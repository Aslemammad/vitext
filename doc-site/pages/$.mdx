...
[vite-plugin-react-page](https://github.com/vitejs/vitext) (vite-pages) is a React app framework powered by [vite](https://github.com/vitejs/vite). It is very suitable for:
