...
When [configuring vitext](https://github.com/vitejs/vitext/blob/master/packages/playground/custom-find-pages/vite.config.ts), you can pass the `pageStrategy` option. It should be an instance of `PageStrategy` class. Here is an example of customizing pageStrategy:
...
> Checkout the complete example in [the custom-find-pages2 fixture](https://github.com/vitejs/vitext/blob/master/packages/playground/custom-find-pages2/vite.config.ts).
...
Checkout [the custom-find-pages2 fixture](https://github.com/vitejs/vitext/blob/master/packages/playground/custom-find-pages2/vite.config.ts) for an example.
...
Checkout [the custom-find-pages fixture](https://github.com/vitejs/vitext/blob/master/packages/playground/custom-find-pages/vite.config.ts) for an example.
...
[Here is the complete definition of DefaultPageStrategy](https://github.com/vitejs/vitext/blob/master/packages/vitext/src/node/dynamic-modules/DefaultPageStrategy/index.ts). And <Link to="/examples/component-library">here is an example of using it</Link>.
