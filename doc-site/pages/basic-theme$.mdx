...
[Here is a complete example](https://github.com/vitejs/vitext/tree/master/packages/playground/use-theme).
...
The `createTheme` exported by `vite-pages-theme-basic` accepts [these options](https://github.com/vitejs/vitext/blob/master/packages/theme-basic/src/index.tsx):
...
> Contributions to [the basic theme](https://github.com/vitejs/vitext/tree/master/packages/theme-basic) are always welcomed.
