...
Checkout the [analyze-source-code fixture](https://github.com/vitejs/vitext/blob/master/fixtures/analyze-source-code/pages/index$.tsx) for an example.
...
If you come up with more useful magic imports, [feel free to open an issue or PR](https://github.com/vitejs/vitext/issues). Contributions are always welcomed!
