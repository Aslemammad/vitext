...
> Here is an example implementation of vite-pages theme: [vite-pages-theme-basic](https://github.com/vitejs/vitext/blob/master/packages/theme-basic/src/index.tsx). [This fixture](https://github.com/vitejs/vitext/blob/master/packages/playground/use-theme/pages/_theme.tsx) demonstrate how to use it.
