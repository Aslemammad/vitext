...
This is probably [the simplest theme](https://github.com/vitejs/vitext/blob/master/packages/playground/basic/pages/_theme.tsx):

```tsx
import React, { useMemo } from 'react'
import type { Theme } from 'vitext'
...
> Here is a more useful theme: [vite-pages-theme-basic](https://github.com/vitejs/vitext/blob/master/packages/theme-basic/src/index.tsx). [This fixture](https://github.com/vitejs/vitext/blob/master/packages/playground/use-theme/pages/_theme.tsx) demonstrate how to use it.
...
> You can refer to [vite-pages-theme-basic](https://github.com/vitejs/vitext/blob/master/packages/theme-basic/src/index.tsx)
