...
import initialPages from '/@vitext/pages'
// import initialTheme from '/@vitext/theme'

// TODO: simplify this
// there is no easy way to handle the hmr of module such as `/@vitext/pages/page1` so stop trying it
// https://github.com/vitejs/vitext/pull/19#discussion_r604251258
...
if (import.meta.hot) {
  ...
  // import.meta.hot!.accept('/@vitext/theme', (module) => {
  ...
  import.meta.hot!.accept('/@vitext/pages', (module) => {
...
if (globalObject['__vite_pages_use_static_data']) {
  throw new Error(
    `[vitext] useStaticData already exists on window. There are multiple vitext apps in this page. Please report this to vitext.`
  )
} else {
  // make it available to vitext/client
